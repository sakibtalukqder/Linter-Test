    ...
    return (
        <>
            ...
            <footer className="footer (p-10 bg-neutral) lg:px-12 p-10 ">
                ...
                <nav>
                    <header className="text-lg font-bold">Social Links</header>
                    ...
                    <Link  className='btn-outline btn-accent btn btn-sm rounded-none' to={"/about/members"}>Help & Support</Link>
